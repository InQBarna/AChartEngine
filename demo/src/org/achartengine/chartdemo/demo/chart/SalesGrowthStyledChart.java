 ...
 */
public class SalesGrowthStyledChart extends AbstractDemoChart {
  /**
  ...
  public String getDesc() {
    return "The sales growth across several years (time chart) with style";
  }
  ...
  public Intent execute(Context context) {
    ...
    xyRenderer.setFillOutsideLine(FillOutsideLine.ABOVE);
